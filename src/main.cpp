...
int main(int argc, const char* argv[])
{
    if (argc < 2)
    {
        ...
        std::cerr << "Usage: " << exe << " <name> [-instance=<instance>] [-video_mode <video mode>] [-video_connection <video connection>] [-video_format <video format>] [-audio_connection <audio connection>]" << std::endl;
